...
from mptt.models import MPTTModel, TreeForeignKey  # mptt help retrive hirarchial datas
...
class Category(MPTTModel):
    ...
    name = models.CharField(
        verbose_name=_("Category Name"),  # "_" allow inernalization for translation
        help_text=_("Required and unique"),
        max_length=255,
        unique=True,
    )
    slug = models.SlugField(verbose_name=_("Category safe URL"), max_length=255, unique=True)
    # defining one category cannected to another category footwhere parrent shoe chappel child
...
class ProductSpecification(models.Model):
    ...
    )  # restricted means the product type cant dleted becuse we have productspecification to block the deletion
...
class ProductImage(models.Model):
    ...
    is_feature = models.BooleanField(default=False)  # main image show p for all page
